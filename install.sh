...
BINARY_NAME="auto-claude"
REPO_URL="https://raw.githubusercontent.com/iKislay/auto-claude/main"
...
if ! curl -fsSL "$REPO_URL/auto_claude.sh" -o "$INSTALL_DIR/$BINARY_NAME"; then
...
echo ""
echo "For more information, visit: https://github.com/iKislay/auto-claude"
