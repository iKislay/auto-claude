<h1><img width="512" height="294" alt="Auto-Claude" src="./screenshot.png" /></h1>
...
My friends at GitHub Next are exploring similar ideas. Their researcher nailed the fault-tolerance insight: *"If things go wrong, it just hits resource limits and tries again. You throw away bad PRs. Better than frustrated users stuck guiding agents down wrong paths."*
